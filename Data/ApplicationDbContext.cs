    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Equipment>().HasData(
                ...
                new Equipment { EquipmentId = 2, Type = "Laptop", Description = "MacBook Pro 13-inch", Availability = true },
                new Equipment { EquipmentId = 3, Type = "Tablet", Description = "iPad Air", Availability = true },
                new Equipment { EquipmentId = 4, Type = "Phone", Description = "iPhone 13", Availability = true },
